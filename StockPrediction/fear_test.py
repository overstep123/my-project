...
def test_feature(date_after,bar,count):
    ...
    engine = sa.create_engine('mysql+pymysql://gupiao:gupiao@127.0.0.1/stocktool?charset=utf8')
...
with progressbar.ProgressBar(max_value=10000,redirect_stdout=True) as bar:
    test_feature('2018-05-17',bar,0)
